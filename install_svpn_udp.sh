...
perform_install_manager_script() {
    ...
    curl -o "$_manager_script" "https://raw.githubusercontent.com/sansoe2022/udp/refs/heads/main/svpn_udp_manager.sh?token=GHSAT0AAAAAADCWXCHVVP734RZBTJJSHTY22BZ2QGQ"
